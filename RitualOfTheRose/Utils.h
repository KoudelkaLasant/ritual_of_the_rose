...
public:
	...
	void defineCombatPlayerImages() {
		...
		animationFrames["Enraged Noblewoman"]["COMBAT_BACK"].internalList = { COMBAT_ENRAGEDNOBLEWOMAN_BACK_1 };
		animationFrames["Enraged Noblewoman"]["COMBAT_FRONT"].internalList = { COMBAT_ENRAGEDNOBLEWOMAN_FRONT_1 };
